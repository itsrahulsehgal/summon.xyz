  ...
  <div className="px-5 pt-20 md:px-0">
    ...
    <div className="mx-auto flex max-w-6xl flex-col gap-10">
      <div>
        ...
        <p>
          Welcome to Summon ("Company", "we", "our", "us")! These Terms of
          Service ("Terms", "Terms of Service") govern your use of our website
          located at www.summon.xyz ("Website") and our blockchain services
          provided on this Website ("Services").
        </p>
        <br />
        <p>
      ...
      <div>
        <h5 className="text-white">2. Eligibility</h5>
        <p>
          By using our Services, you represent and warrant that you are at least
          18 years old and that you have the legal capacity to enter into these
          Terms. If you are using our Services on behalf of a company,
          organization, or other legal entity, you represent and warrant that
          you are authorized to do so.
        </p>
      </div>
      <div>
        <h5 className="text-white">3. Services</h5>
        <p>
          Our Services include providing a platform for blockchain transactions.
          We do not guarantee the accuracy, completeness, or usefulness of any
          information on the Website and we do not adopt nor endorse, nor are we
          responsible for, the accuracy or reliability of any opinion, advice,
          or statement made by parties other than us.
        </p>
      </div>
      <div>
        <h5 className="text-white">4. User Accounts</h5>
        <p>
      ...
      <div>
        <h5 className="text-white">5. Intellectual Property Rights</h5>
        <p>
          ...
          graphics on the Website (collectively, the "Content") and the
          trademarks, service marks, and logos contained therein (the "Marks")
          are owned or controlled by us or licensed to us.
        </p>
      </div>
      <div>
        <h5 className="text-white">6. User Data</h5>
        <p>
          We will maintain certain data that you transmit to the Website for the
          purpose of managing the performance of the Website, as well as data
      ...
      <div>
        <h5 className="text-white">7. Privacy</h5>
        <p>
          Your use of the Website is also governed by our Privacy Policy. Please
          review our Privacy Policy, which also governs the Website and informs
          users of our data collection practices.
        </p>
      </div>
      <div>
        <h5 className="text-white">8. Blockchain Risks</h5>
        <p>
          You acknowledge and agree that there are risks associated with
          utilizing blockchain-based services, including, but not limited to,
      ...
      <div>
        <h5 className="text-white">9. Limitation of Liability</h5>
        <p>
          In no event will we or our directors, employees, or agents be liable
          to you or any third party for any direct, indirect, consequential,
          exemplary, incidental, special, or punitive damages, including lost
          profit, lost revenue, loss of data, or other damages arising from your
          use of the Website and our Services, even if we have been advised of
          the possibility of such damages.
        </p>
      </div>
      <div>
        <h5 className="text-white">10. Dispute Resolution</h5>
        <p>
          Any disputes arising out of or relating to these Terms of Service or
          the Services will be resolved in accordance with the laws of Cayman
          Islands.
        </p>
      </div>
      <div>
        <h5 className="text-white">11. Changes to Terms</h5>
        <p>
      ...
      <div>
        <h5 className="text-white">12. Contact Us</h5>
        <p>
