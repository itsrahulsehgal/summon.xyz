  ...
  <div className="px-5 pt-20 md:px-0">
    ...
    <div className="mx-auto flex max-w-6xl flex-col gap-10">
      <div>
        ...
        <p>
          Summon ("we", "us", "our") uses cookies on our website www.summon.xyz
      ...
      <div>
        <h5 className="text-white">2. What are cookies?</h5>
        <p>
      ...
      <div>
        <h5 className="text-white">3 How Summon uses cookies</h5>
        <p>
          When you use and access the Website, we may place a number of cookies
          files in your web browser. We use cookies for the following purposes:
        </p>
      </div>
      <div>
        <h5 className="text-white">3.1 Essential cookies</h5>
        <p>
          We use essential cookies to authenticate users and prevent fraudulent
          use of user accounts.
        </p>
      </div>
      <div>
        <h5 className="text-white">3.2 Performance cookies</h5>
        <p>
          These cookies allow us to count visits and traffic sources so we can
          measure and improve the performance of our Website. They help us to
          know which pages are the most and least popular and see how visitors
          move around the Website.
        </p>
      </div>
      <div>
        <h5 className="text-white">3.3 Analytics cookies</h5>
        <p>
          We use analytics cookies to track information on how the Website is
          used so that we can make improvements. We may also use analytics
          cookies to test new advertisements, pages, features or new
          functionality of the Website to see how our users react to them.
        </p>
      </div>
      <div>
        <h5 className="text-white">4. Third-party cookies</h5>
        <p>
